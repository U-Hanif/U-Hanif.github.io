...
title: "ENVOT: Attestation of IoT Swarms for Anomalies Using ENsemble Classifier and VOTing Mechanism"
...
abstract: |
  ...
  compromised nodes. The framework incorporates techniques including
  Variational Autoencoders, ensemble learning, and SMOTE-based class balancing
  to address heterogeneous data and imbalanced attack scenarios. By combining
  the predictions of multiple classifiers through a voting mechanism, ENVOT
  provides a robust and scalable approach to anomaly detection and attestation
